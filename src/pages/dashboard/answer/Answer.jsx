...
function Answer() {
  ...
  const { language } = useSelector((state) => state.assistant)
  ...
  const sumbitTableHandler = () => {
    const adapter = { answers: dataTable, language: language, uid: uid }
  ...
  const submitModalHandler = () => {
    ...
    const adapter = { answers: dataSend, language: language, uid: uid }
    updateAnswers({ variables: adapter })
      .then(() => {

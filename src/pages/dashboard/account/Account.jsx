    ...
    <div className={styles.container}>
      <form className={styles.group}>
        ...
        <fieldset className={styles.fields}>
          <InputGroup label="Full Name" name="name" order="rowed">
            <Input
              name="name"
              type="text"
              info="normal"
          ...
          <InputGroup label="Email" name="email" order="rowed">
            <Input
              name="email"
              type="email"
              info="normal"
          ...
          <InputGroup label="Company Name" name="company" order="rowed">
            <Input
              name="company"
              type="text"
              info="normal"
          ...
          <InputGroup label="Phone Number" name="phoneNumber" order="rowed">
            <Phone
              value={input}
              onChange={setInput}
      ...
      <form className={styles.group} onSubmit={handleSubmitAddress}>
        ...
        <fieldset className={styles.fields}>
          <InputGroup label="Country" name="country" order="rowed">
            <Country
              name="country"
              info="normal"
              value={form.country}
          ...
          <InputGroup label="City" name="city" order="rowed">
            <Input
              name="city"
              type="text"
              info="normal"
          ...
          <InputGroup label="Address" name="address" order="rowed">
            <Input
              name="address"
              type="text"
              info="normal"
